...
import { ExternalConnectors } from "./components/ExternalConnectors";
import { TicketAnalytics } from "./components/TicketAnalytics";
import { SAPSolutionManager } from "./components/SAPSolutionManager";
...
const mockPermissions: Permission[] = [
  ...
  },
  {
    ...
    description: "Can view their own tickets",
    category: "Tickets",
  },
  {
    id: "view_all_tickets",
    name: "View All Tickets",
    description: "Can view tickets from all users",
    category: "Tickets",
  },
  {
    id: "approve_tickets",
    name: "Approve Tickets",
    description: "Can approve tickets requiring approval",
    category: "Tickets",
  },

  // Access Management
  {
    id: "request_database_access",
    name: "Request Database Access",
    description: "Can request access to databases",
    category: "Access",
  },
  {
    id: "self_approve_basic",
    name: "Self-Approve Basic Requests",
    description: "Can approve their own basic access requests",
    category: "Access",
  },
  {
    id: "approve_access_requests",
    name: "Approve Access Requests",
    description:
      "Can approve access requests from team members",
    category: "Access",
  },
  ...
  // System Management
  {
    ...
    description: "Can view system health and status",
    category: "System",
  },
  {
    id: "manage_infrastructure",
    name: "Manage Infrastructure",
    description: "Can manage cloud infrastructure",
    category: "System",
  },
  {
  ...
  {
    id: "chat_with_ai",
    name: "Chat with AI Guardian",
    description: "Can interact with AI assistant",
    category: "AI",
  },
  {
    id: "view_proactive_alerts",
    name: "View Proactive Alerts",
    description: "Can see AI-generated proactive alerts",
    category: "AI",
  },
  ...
  // Hardware Management
  {
    ...
    description: "Can request hardware replacements",
    category: "Hardware",
  },
  {
    id: "manage_hardware",
    name: "Manage Hardware",
    description: "Can manage hardware inventory",
    category: "Hardware",
  },
...
const mockRoles: Role[] = [
  ...
  },
  {
    ...
    description:
      "Senior technical role with advanced system access",
    isCustom: false,
    permissions: [
      "create_ticket",
      "view_own_tickets",
        ...
        <div className="min-h-screen bg-background">
          <Routes>
            ...
            <Route
              ...
              element={
                isAuthenticated && user?.isAdmin ? (
                  <ExternalConnectors onLogout={handleLogout} />
                ) : (
                  <Navigate to="/login" replace />
                )
              }
            ...
            <Route
              ...
              element={
                isAuthenticated && user?.isAdmin ? (
                  <TicketAnalytics onLogout={handleLogout} />
                ) : (
                  <Navigate to="/login" replace />
                )
              }
            />
            <Route
              path="/sap-solution-manager"
              element={
                isAuthenticated && user?.isAdmin ? (
                  <SAPSolutionManager onLogout={handleLogout} />
                ) : (
                  <Navigate to="/login" replace />
                )
              }
